import { useAddress,
   ...
   useDisconnect,
    useContractData,
     useContractCall } from '@thirdweb-dev/react';
...
const Home: NextPage = () => {
  ...
  const {contract, isLoading}= useContract(
    ...
    const { data: remainingTickets } = useContractData(contract,
       "RemainingTickets");
    const { data :currentWinningReward } = useContractData(contract,
  ...
  return (
    <div className="bg-[#091B18] min-h-screen flex flex-col">
      <Head>
        <title>Apni lottery</title>
      </Head>
      <div className='flex-1'>

      <Header/>
      <Marquee className='bg-[#0A1F1C] p-5 mb-5'
      ...
      {winnings>0 &&(
        ...
        mx-auto mt-5'>
          ...
          } className='p-5 bg-gradient-to-b
          from-orange-500 to-emerald-600
          animate-pulse text-center rounded-xl
          w-full'>
          ...
          <div className='stats-container space-y-2'>
            <div className='stats-container'>
             ...
             {currency}
              ...
              <div className='flex text-white text-center space-x-2 
              bg-[#092B28]
              border-[#004337] border p-4'>
                <p>TICKETS</p>
                <input className='flec w-full bg-transparent 
                text-right outline-none' type='number'
                min={1}
                max={10}
                value={quantity}
                ...
                {currency}
                 ...
                 <div>
                  ...
                  <div className='flex max-w-sm flex-wrap gap-x-2 gap-y-2'>
                    ...
                    (
                      <p
                       key={index} className='text-emerald-300 h-20
                      w-12 bg-emerald-500/30 rounded-lg flex flex-shrink-0
    ...
    text-white justify-between p-5'>
      <img className='h-10 w-10 filter hue-rotate-90 opacity-20
      rounded-full'
